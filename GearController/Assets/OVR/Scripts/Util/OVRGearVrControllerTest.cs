...
//      NOTE 
/////////////////////////////////////////////
//This is an adaptation of Oculus' controller example, to make easy to understand as many developers would also be looking at Oculus' example. 
//It's not necessarily the best location to add logic as this script is attached to a 'Text' GameObject.
/// </summary>
...
public class OVRGearVrControllerTest : MonoBehaviour
{
    ...
    //Make sure these objects are linked

    //Link to the 'ball' GameObject
    public GameObject projectilePrefab;
    //Link to OVRCameraRig - TrackingSpace - CenterEyeAnchor
    public GameObject centerCamera;
    //Link to OVRCameraRig - TrackingSpace - LeftHandAnchor and OVRCameraRig - TrackingSpace - RightHandAnchor, respectively
    public GameObject leftHand, rightHand;

    // This function shoots a projectile from the right hand position and right hand pointing direction
    public void shootProjectile()
    {
        //Creates a copy of the projectile
        GameObject projectile = GameObject.Instantiate(projectilePrefab);
        //Since we are shooting in a first person fashion, shoot it 
        //from where the right hand is. (modify this for left hand)
        projectile.transform.position = rightHand.transform.position;

        //The projectile is assumed to have a RigidBody
        Rigidbody rb = projectile.GetComponent<Rigidbody>();
        //Get the pointing direction of the right hand
        Vector3 look = rightHand.transform.forward;
        
        //Set the projectile velocity to be some magnitude of the looking direction
        rb.velocity = look * 1;

        //Alterantively, apply a force instead of setting velocity
